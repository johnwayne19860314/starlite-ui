...
// const userApi = {
//   //登录
//   'POST /api/v1/user/login': async (req: Request, res: Response) => {
...
//   },
//   //用户信息
//   'GET /api/v1/user/info': async (req: Request, res: Response) => {
//     await waitTime(2000);
...
//   },
//   //用户权限
//   'GET /api/v1/user/authority': async (req: Request, res: Response) => {
//     await waitTime(1500);
...
//   },
//   //菜单
//   'GET /api/v1/user/menu': async (req: Request, res: Response) => {
//     await waitTime(1000);
...
//   },
//   //验证码
//   'GET /api/v1/user/captcha': async (req: Request, res: Response) => {
//     await waitTime(2000);
//     return res.send(
//       handleCommonRes({
//         captcha: 'captcha-xxx'
